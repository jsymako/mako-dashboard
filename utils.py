...
def custom_fullscreen_spinner(text="로딩 중입니다..."):
    ...
    html_code = (
        ...
        ".fs-text { font-family: 'Pretendard', sans-serif !important; font-size: 1.6rem !important; font-weight: 700 !important; color: #F8FAFC !important; text-shadow: 0 4px 10px rgba(0,0,0,0.5) !important; animation: fs-pulse 1.5s ease-in-out infinite !important; margin: 0 !important; padding: 0 !important; }"
