...
with st.sidebar:
    ...
    st.sidebar.markdown('<hr style="border-top: 1px solid rgba(255, 255, 255, 0.5); margin: 0px 0px 0px 0px !important; padding: 0px 10px !important;">', unsafe_allow_html=True)
