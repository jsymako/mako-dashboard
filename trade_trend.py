...
def run(load_data_func):
    ...
    try:
        ...
        # ==========================================
        # 🚀 6. 향후 12개월 수요 예측 (가중 평균 알고리즘 고도화 적용)
        # ==========================================
            ...
            if len(m_data) < 12:
                ...
                # 과거 실적(회색 실선) / 향후 예측(보라색 점선) 중첩 그래프
                ...
                # 글자 크기를 키운 커스텀 HTML 테이블 생성 및 주입
