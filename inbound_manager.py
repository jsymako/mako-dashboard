                        ...
                        <div style="border: 1px solid #E2E8F0; border-left: 5px solid #2E86C1; border-radius: 6px; overflow: hidden; background-color: #FFFFFF; margin-bottom: 2px;">
                            <table style="width:100%; border-collapse: collapse; text-align: left; margin: 0px !important; padding: 0px !important;">
                                <tr style="font-size: 1.4rem; color:#444;">
                                    <td rowspan="2" style="padding: 15px; text-align: center; width: 12%; font-size: 4rem; color:#111; background-color: #F8F9FA; border-right: 1px solid #E2E8F0; border-bottom: none;"><b>{row['차수']}차</b></td>
                                ...
                                <tr style="font-size: 1.4rem;">
                                    <td colspan="5" style="padding: 12px 15px; color:#2C3E50; border-bottom: none;">📝 <b>적요:</b> {row.get('적요','') if str(row.get('적요','')).strip() != "" else "<span style='color:#A0AEC0;'>없음</span>"}</td>
                                </tr>
                            </table>
                        </div>
                        """
