...
def run(load_data_func):
    ...
    st.markdown("""
        <style>
        .block-container h1 {
            font-size: 2.5rem !important;        /* 글자 크기 (기본보다 더 크고 시원하게) */
            font-weight: 700 !important;         /* 글자 굵기 (가장 두껍고 단단하게) */
    ...
    with col_chart1:
        ...
        html_m = m_t.style.set_properties(**{
            ...
            'selector': 'th', 
            'props': [('font-size', '29px'), ('text-align', 'center'), ('background-color', '#f4f6f9'), ('padding', '12px'), ('border', '1px solid #e0e0e0')]
        }, {
            'selector': 'table',
